...
static void taskParseJson(void)
{
    ...
    while (1)
    {
        ...
        {
            pcChallenge = cJSON_GetObjectItem( jsCmd , "challenge" )->valuestring;
...
static void taskRegister(void)
{
    ...
    while (1)
    {
        ...
        /* build C-R json and send json ptr to xQueueJsonToSend */
        cJSON *jsonCR = makeJson_CR();
        xQueueSend( xQueueJsonToSend, ( void * ) &jsonCR, 100 / portTICK_RATE_MS );
    }
