...
void app_main() {
	...
	// xTaskCreate((TaskFunction_t)mainTaskAuthenticate, /* Pointer to the function that implements the
	// task. */
	//             "defaultTask",                        /* Text name for the task.  This is to facilitate
	//             debugging only. */ 1024 * 16,                            /* Stack depth in words. */
	...
	// xTaskCreate(	(TaskFunction_t)mainTaskAuthenticate,		/* Pointer to the function that
	// implements the task. */ 				"mainTaskAuthenticate",	/* Text name for the
	// task. This is to
	// facilitate debugging only. */ 				1024*16,		/* Stack depth
	// in words.
	// */ 				NULL,		/* We are not using the task parameter. */
	// 				tskIDLE_PRIORITY,			/* This task will run at
	// priority 1.
	...
	// /* test freertos */
	// xTaskCreate(	(TaskFunction_t)mainTaskAuthenticate,		/* Pointer to the function that
	// implements the task. */ 				"defaultTask",	/* Text name for the task.
	// This is to facilitate debugging only. */ 				1024*16,		/*
	// Stack depth
	// in words. */ 				NULL,		/* We are not using the task
	// parameter.
